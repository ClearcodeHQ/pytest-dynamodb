Contribute to pytest-dynamodb
==============

Thank you for taking time to contribute to pytest-dynamodb!

The following is a set of guidelines for contributing to pytest-dynamodb. These are just guidelines, not rules, use your best judgment and feel free to propose changes to this document in a pull request.
...
#. Additional, not always mandatory checks are being performed by `QuantifiedCode <https://www.quantifiedcode.com/app/project/gh:ClearcodeHQ:pytest-dynamodb>`_
